...
Semantic Matching: Uses FAISS and all-MiniLM-L6-v2 to rank candidates based on meaning, not just keywords.
...
Visual Leaderboard: Dynamic charts and color-coded feedback for instant decision-making.
...
User Upload: Recruiter uploads PDFs via Streamlit.

Vectorization: Backend converts text to vectors using HuggingFace.

Storage: Vectors are indexed in FAISS.

Retrieval: System calculates Cosine Similarity between JD and Resumes.

Generation: LLMs handle chat interactions and JD drafting.
